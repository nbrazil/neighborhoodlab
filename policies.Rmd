...
* Presenting results to the full lab group to get feedback and reaction.
* Presenting results at a professional conference. This is usually a PowerPoint presentation, but also can be a [poster](https://urc.ucdavis.edu/creating-effective-academic-posters). Lab members have presented at the [Population Association of America's](https://www.populationassociation.org/events-publications/future-past-meetings) annual conference, the [American Sociological Association's](https://www.asanet.org/annual-meeting/) conference, and [Association for Public Policy Analysis and Management](https://www.appam.org/) conference.
